    ...
    <div className="box">
      <div className="info">
        <div className="bulletin">
          == Contract Name: {name} - <a href={config.explorer + config.daily_payout} target="_blank" rel="noreferrer" >Check on Explorer</a> - <a href="/ABI/DailyPayout.json" target="_blank" rel="noreferrer" >Contract ABI</a> ==
        </div>
        <ul>
        ...
        <ul>
          ...
          <li>
            <form>
              ...
              <input type="text" placeholder="address" size="50" onChange={e=>setAddressClaimable(e.target.value)} />
          ...
          <li>
            <form>
              ...
              <input type="text" placeholder="address" size="50" onChange={e=>setAddressIsOperator(e.target.value)} />
